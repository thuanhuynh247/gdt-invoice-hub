...
## 📌 Hạng mục: Related-Party Transaction Markup & Interquartile (IQR) Margin Risk Analyzer (Story ID: US-410)

---

### 📊 1. THÔNG TIN HỆ THỐNG & ĐIỀU HÀNH (Operating System & telemetry)
- **Tên Agent chịu trách nhiệm**: `Antigravity`
- **Thời gian nghiệm thu (UAT Time)**: `2026-06-06 07:40:00`
...
- **Hành động đã làm (Actions Taken)**:
  - Implement dynamic IQR margin risk engine for related-party transaction calculations.
  - Reconcile costs and markup percentages, mapping against statutory ranges (p35 to p75).
  - Calculate tax adjustments (CIT underpaid) and administrative penalities.
