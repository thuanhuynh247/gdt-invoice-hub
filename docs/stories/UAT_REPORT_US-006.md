...
## 📌 Hạng mục: Asynchronous Batch Invoice Downloading (Story ID: US-006)
...
- **Hành động đã làm (Actions Taken)**:
  - `Trigger batch downloads asynchronously via daemon thread and add status API and progress modal`
- **Tệp tin đã đọc (Files Read)**:
  - `docs/stories/us_async_batch_download.md`
