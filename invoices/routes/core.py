...
def api_compliance_concept_map():
    ...
    nodes = [
        ...
        {"id": "v81", "label": "PIT Withholding & Form 08 Hub (v81)", "group": "income", "risk": "high", "url": "/v81-compliance-hub", "status": "active"},
        {"id": "v82", "label": "Tax Settlement & CIT Deductibility Hub (v82)", "group": "income", "risk": "high", "url": "/v82-compliance-hub", "status": "active"},
    ]
    ...
    links = [
        ...
        {"source": "v26", "target": "v81", "type": "subset", "label": "Personal Income Tax & Withholding Audit"},
        {"source": "v26", "target": "v82", "type": "subset", "label": "Tax Settlement & CIT Deductibility Audit"},
...
def api_compliance_concept_map_expand(version_id):
    ...
    from invoices.routes.compliance_pages_data import get_compliance_pages
    pages = get_compliance_pages(version_id, mst, db_stats)
