...
- [ ] **Task 79 (br-201)**: SEE - Tái cấu trúc CSS hệ thống và Theme Switcher (`static/css/style.css`, `templates/base.html`).
- [ ] **Task 80 (br-202)**: SEE - Cải tiến trang Tra cứu Hóa đơn và Bento Grid KPI (`templates/invoices.html`).
- [ ] **Task 81 (br-203)**: SEE - Vẽ biểu đồ dòng tiền SVG chuyển sắc (`templates/cashflow.html`).
- [ ] **Task 82 (br-204)**: SEE - Tối ưu hóa Form CRO Phát hành & Đăng nhập (`templates/issue_invoice.html`, `templates/login.html`).
- [ ] **Task 83 (br-205)**: RUN - Rà soát Captcha Solver, Archiver & Nâng cấp Pytest Suite (`auth/captcha_solver.py`, `invoices/archiver.py`, test suite).
